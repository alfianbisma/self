...
creator=["u7fd29ae17122147632fc57cde32ed310"]
owner =["u7fd29ae17122147632fc57cde32ed310"]
admin = ["u7fd29ae17122147632fc57cde32ed310"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Start---------------------#
            elif msg.text in ["Indahnya pemandangan"]:
            	ki.sendText(msg.to,"Banyak Lonte Lonte Mau Di Jual")
